...
package com.ls.aegis.security.config.satoken;
...
import com.ls.aegis.security.crud.CrudApiPermissionPrefixCache;
...
public class SaTokenConfiguration {
    ...
    /** 开放接口签名模板（由业务模块可选提供，例如 ls-aegis-biz-open 的 OpenApiSignTemplate） */
    private final ObjectProvider<SaSignTemplate> signTemplateProvider;
    ...
    public SaInterceptor saInterceptor() {
        signTemplateProvider.ifAvailable(SaSignManager::setSaSignTemplate);
