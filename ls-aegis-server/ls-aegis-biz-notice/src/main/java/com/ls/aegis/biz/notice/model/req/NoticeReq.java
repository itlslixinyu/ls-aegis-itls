...
package com.ls.aegis.biz.notice.model.req;
...
public class NoticeReq implements Serializable {
    ...
    @SpelNotEmpty(condition = "#this.noticeScope == T(com.ls.aegis.biz.notice.enums.NoticeScopeEnum).USER", message = "通知用户不能为空")
