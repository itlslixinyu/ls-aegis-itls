...
import com.ls.aegis.common.model.req.CommonStatusUpdateReq;
import com.ls.aegis.common.util.SecureUtils;
import com.ls.aegis.biz.file.enums.StorageTypeEnum;
import com.ls.aegis.biz.file.mapper.StorageMapper;
import com.ls.aegis.biz.file.model.entity.StorageDO;
import com.ls.aegis.biz.file.model.query.StorageQuery;
import com.ls.aegis.biz.file.model.req.StorageReq;
import com.ls.aegis.biz.file.model.resp.StorageResp;
...
public class StorageServiceImpl extends BaseServiceImpl<StorageMapper, StorageDO, StorageResp, StorageResp, StorageQuery, StorageReq> implements StorageService {
    ...
    private String decryptSecretKey(String encryptSecretKey, StorageDO oldStorage) {
        ...
        // 解密（国密开启时前端为 SM2，关闭时兼容 RSA）
        String secretKey = ExceptionUtils.exToNull(() -> SecureUtils.decryptTransport(encryptSecretKey));
