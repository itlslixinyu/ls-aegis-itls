...
package com.ls.aegis.biz.open.mapper;
...
public interface AppMapper extends BaseMapper<AppDO> {
    ...
    AppDO selectByAccessKey(@FieldEncrypt(encryptor = com.ls.aegis.crypto.encryptor.Sm4Encryptor.class) @Param("accessKey") String accessKey);
}