...
package com.ls.aegis.biz.schedule.model.resp;

import io.swagger.v3.oas.annotations.media.Schema;
import lombok.Data;
import com.ls.aegis.biz.schedule.enums.JobExecuteReasonEnum;
import com.ls.aegis.biz.schedule.enums.JobExecuteStatusEnum;
...
public class JobLogResp implements Serializable {
     ...
     * 任务组
     */
    @Schema(description = "任务组", example = "ls-aegis")
