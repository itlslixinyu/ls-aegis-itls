...
import com.ls.aegis.common.api.tenant.PackageMenuApi;
import com.ls.aegis.common.api.tenant.TenantApi;
...
import com.ls.aegis.rbac.mapper.user.UserPasswordHistoryMapper;
...
public class TenantDataApiForSystemImpl implements TenantDataApi {
    ...
    private final MessageLogMapper messageUserMapper;
