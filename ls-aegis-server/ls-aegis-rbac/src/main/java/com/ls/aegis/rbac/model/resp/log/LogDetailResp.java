...
package com.ls.aegis.rbac.model.resp.log;
...
public class LogDetailResp implements Serializable {
     ...
     * 请求 URL
     */
    @Schema(description = "请求 URL", example = "http://localhost:8000/system/dept")
     ...
     * 请求头
     */
    @Schema(description = "请求头", example = "{\"Origin\": [\"http://localhost:5173\"],...}")
