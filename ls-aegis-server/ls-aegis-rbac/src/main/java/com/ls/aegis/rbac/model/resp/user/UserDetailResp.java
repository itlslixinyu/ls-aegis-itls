...
import com.ls.aegis.common.constant.ContainerConstants;
...
import com.ls.aegis.rbac.model.resp.DeptResp;
...
public class UserDetailResp extends BaseDetailResp {
    ...
    @FieldEncrypt(encryptor = com.ls.aegis.crypto.encryptor.Sm4Encryptor.class)
